...
/* GRAMMAR */
GRAMMAR:
	%empty { yyerror( "Empty input source is not valid!" ); YYERROR; }
	| error
...
/* CONST_DECLS */
CONST_DECLS: %empty | CONST_DECLS CONST_DECL ';';
...
/* VAR_DECLS */
VAR_DECLS: %empty | VAR_DECLS VAR_DECL ';';
...
/* OPT_FORMAL_PARAMS */
OPT_FORMAL_PARAMS: %empty | FORMAL_PARAMS;
...
/* OPT_VAR */
OPT_VAR: %empty | KW_VAR;

/* OPT_RET_TYPE */
OPT_RET_TYPE: %empty | ':' QUALIDENT;
...
/* QUALIF */
QUALIF: %empty | '[' SUBSCRIPTS ']' QUALIF | '.' IDENT QUALIF;
...
/* FACTOR */
FACTOR: INTEGER_CONST | FLOAT_CONST | STRING_CONST | CHAR_CONST | IDENT QUALIF | PROCEDURE_CALL | '(' EXPR ')' | KW_NOT FACTOR %prec NEG | '-' FACTOR %prec NEG;
...
/* ELSIFS */
ELSIFS: %empty | ELSIFS KW_ELSIF EXPR KW_THEN STATEMENTS;

/* ELSE_PART */
ELSE_PART: %empty | KW_ELSE STATEMENTS;
